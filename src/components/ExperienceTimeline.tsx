...
const timeline = [
  {
    ...
    description: "Pursuing CSE with a 9.24 CGPA. Active in cloud computing clubs and hackathons.",
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  },
  {
  ...
  },
  {
    icon: Award,
    date: "2026",
    title: "Advanced Technical Certifications",
    org: "AWS & GitHub",
    description: "Earned AWS Solutions Architect Associate, AWS Developer Associate, and GitHub Foundations certifications.",
